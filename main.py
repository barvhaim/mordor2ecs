...
input_large_dataset_path = '/Users/barh/Desktop/IBM/STIX/resources/mordor-master/datasets/large/apt29/day1/apt29_evals_day1_manual_2020-05-01225525.json'
        ...
        with open(output_large_dataset_path, 'w') as wp:
            for line in lines:
                ...
                if events_count > sample_size:
                    break
                events_count += 1
    print('total events: ' + str(events_count))